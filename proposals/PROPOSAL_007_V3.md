...
[PENDING CROSS-CHECK] This tool does not establish injection, platform-survival, or interoperability claims. Other browsers or renderers; messengers or social-media platforms; API or LLM channels; Windows or Linux; sanitizers, crawlers, IDEs, mobile platforms, and external transports remain pending cross-check. Compound three-codepoint round trips outside the scoped browser observations; pasted-codepoint instrumentation; messenger, social-media, Windows, mobile, LLM API, GitHub, IDE, sanitizer, scraper, and renderer transit remain to be tested.
...
[OBSERVED — SCOPED] The tool recorded the browser selection/copy observations described above; they do not establish a general clipboard, transport, or injection-path result.
